...
class AggForce:
    def __init__(self, pdb, top, z):
        ...
        self.logger = logging.getLogger('aggforce')
        
        self.logger.info(f"Number of noh atoms: {len(self.noh_idxs)}")
    ...
    def process_forces(self, forces):
        ...
        for bond in self.constraints:
            ...
            if i in self.noh_idxs and j not in self.noh_idxs:
                ...
                self.logger.error(f"Hydrogen bond between two hydrogen atoms: {i}, {j}")
